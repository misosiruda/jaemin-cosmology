...
권위 있는 공개 원고는 한국어 working-paper release `v0.1.0-ko`입니다. `paper/en/` 아래의 영어 draft scaffold에는 현재 frontmatter, abstract, scope/non-goals, limitations, conclusion의 초기 문안만 들어 있으며, 아직 전체 영문판이나 권위 있는 영어 번역본은 아닙니다.
